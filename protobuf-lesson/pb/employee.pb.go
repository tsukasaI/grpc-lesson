...
type Occipation int32

const (
	Occipation_OCCUPATION_UNKNOWN Occipation = 0
	Occipation_ENGINEER           Occipation = 1
	Occipation_DESIGNER           Occipation = 2
	Occipation_MANAGER            Occipation = 3
)

// Enum value maps for Occipation.
var (
	Occipation_name = map[int32]string{
		0: "OCCUPATION_UNKNOWN",
		1: "ENGINEER",
		2: "DESIGNER",
		3: "MANAGER",
	}
	Occipation_value = map[string]int32{
...
func (x Occipation) Enum() *Occipation {
	p := new(Occipation)
	*p = x
	return p
}

func (x Occipation) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Occipation) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_employee_proto_enumTypes[0].Descriptor()
}

func (Occipation) Type() protoreflect.EnumType {
	return &file_proto_employee_proto_enumTypes[0]
}

func (x Occipation) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Occipation.Descriptor instead.
func (Occipation) EnumDescriptor() ([]byte, []int) {
...
type Employee struct {
	...
	Occupation  Occipation                  `protobuf:"varint,4,opt,name=occupation,proto3,enum=employee.Occipation" json:"occupation,omitempty"`
...
func (x *Employee) GetOccupation() Occipation {
	if x != nil {
		return x.Occupation
	}
	return Occipation_OCCUPATION_UNKNOWN
}
...
var file_proto_employee_proto_rawDesc = []byte{
	...
	0x65, 0x6d, 0x70, 0x6c, 0x6f, 0x79, 0x65, 0x65, 0x2e, 0x4f, 0x63, 0x63, 0x69, 0x70, 0x61, 0x74,
	...
	0x56, 0x69, 0x64, 0x65, 0x6f, 0x2a, 0x4d, 0x0a, 0x0a, 0x4f, 0x63, 0x63, 0x69, 0x70, 0x61, 0x74,
...
var file_proto_employee_proto_goTypes = []interface{}{
	(Occipation)(0),         // 0: employee.Occipation
...
var file_proto_employee_proto_depIdxs = []int32{
	0, // 0: employee.Employee.occupation:type_name -> employee.Occipation
